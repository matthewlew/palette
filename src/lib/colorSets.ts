...
export const DEFAULT_COLOR_SET: ColorSet = {
  ...
  colors: [
    ...
    { name: 'Cobalt Cyan', value: { l: 0.72, c: 0.11, h: 195 } },
    { name: 'Ice Blue', value: { l: 0.82, c: 0.12, h: 205 } },
    { name: 'Deep Aqua', value: { l: 0.48, c: 0.08, h: 190 } },
    { name: 'Bubblegum', value: { l: 0.75, c: 0.15, h: 350 } },
    { name: 'Coral Pink', value: { l: 0.65, c: 0.16, h: 15 } },
    { name: 'Orchid', value: { l: 0.58, c: 0.17, h: 335 } },
    { name: 'Amethyst', value: { l: 0.52, c: 0.16, h: 305 } },
    { name: 'Bright Lavender', value: { l: 0.72, c: 0.13, h: 310 } },
    { name: 'Mulberry', value: { l: 0.38, c: 0.12, h: 325 } },
    { name: 'Crimson', value: { l: 0.48, c: 0.19, h: 20 } },
    { name: 'Scarlet', value: { l: 0.56, c: 0.2, h: 30 } },
    { name: 'Hibiscus', value: { l: 0.52, c: 0.18, h: 10 } },
    { name: 'Ultramarine', value: { l: 0.42, c: 0.2, h: 260 } },
    { name: 'Electric Blue', value: { l: 0.62, c: 0.18, h: 250 } },
    { name: 'Lemon Accent', value: { l: 0.85, c: 0.16, h: 105 } },
    { name: 'Marigold Orange', value: { l: 0.65, c: 0.14, h: 65 } },
    { name: 'Emerald', value: { l: 0.55, c: 0.16, h: 140 } },
    { name: 'Lime Accent', value: { l: 0.78, c: 0.18, h: 125 } },
  ],
}
