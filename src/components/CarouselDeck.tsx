        ...
        return (
          ...
          >
            ...
            {gradient.type === 'radial' && gradient.crop === 'oval' && (
              <OvalRadialLayers stops={gradient.stops} angle={gradient.angle} reversed={gradient.reversed} repeatEnabled={gradient.repeatEnabled} hardStops={gradient.hardStops} smoothEnabled={gradient.smoothEnabled} layerCount={16} />
            )}
